...
class ProductRepository @Inject constructor() {
    ...
    val image2 = "https://cdn.shoplightspeed.com/shops/665096/files/48099076/1500x4000x3/crosstree-lane-blue-canvas-boho-bag.jpg"
    val image3 = "https://earthhero.com/cdn/shop/files/gladrags-white-reusable-day-pad-reusable-period-pad-100-cotton-handmade-1-pad-w-2-inserts-30650895401071.jpg?v=1719325921"

    val listOfImages = listOf(image1, image2, image3)

    private val products = listOf(
        Product("1", "Haremke", "Boho pantalone u harem fazonu, najlepse pantalone, divne pantalone, aman odusevice vas sloboda nosenja, dole SNS, ziveo Hrist! Zivot je lep, lep, LEP!", 5500.0, "https://www.culturevulturedirect.co.uk/images/products/large/65124.jpg"),
    ...
    fun getProductById(productId: String): Product? {return products.find { it.id == productId }}
}